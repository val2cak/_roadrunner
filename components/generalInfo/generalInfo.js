    ...
    <Row className="flex items-center bg-gradient-to-b from-hci-general-dark to-hci-general-light">
      ...
      <Col sm={12} lg={6} className="pr-5 lg:pr-72 items-baseline">
        ...
        <p className="text-sm text-white lg:text-md font-regular mb-5 sm:mb-2 flex items-center">
          Do you ever feel like all travel agencies out there only see you as a
          sales statistic? You feel like you don’t really matter as an
          individual. There’s always something hidden, that you find out when
          it’s already too late. 
          <br /> <br />
          With Roadrunner Adventures, YOU matter. We
          promise to always treat you like a friend. With our offers, you get
          what you see. No hidden expenses, no extra charges. 
          <br /> <br />
          So just sit back,
          scroll through our offers and find something for yourself. We have a
          good number of travel destinations. Take your time and find the
          perfect one for you. Enjoy your next trip, we will take care of the
          rest.
        </p>
      </Col>
