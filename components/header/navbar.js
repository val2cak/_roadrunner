            ...
            {navigationItems.map((item, index) => {
                ...
                return (
                    <Link key={item} href={menuItemPath} passHref>
                        <a
                            className={`no-underline text-hci-general-dark mb-2.5 px-7 lg:px-8 py-2 whitespace-nowrap hover:bg-hci-general-middle lg:hover:bg-hci-general-dark font-regular text-2xl ${
